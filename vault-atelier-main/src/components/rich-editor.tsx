...
import { Bold, Italic, UnderlineIcon, Strikethrough, List, ListOrdered, Quote, Heading1, Heading2, CheckSquare, Minus, Link as LinkIcon } from "lucide-react";
...
export function RichTextEditor({
  ...
  useEffect(() => {
    ...
    if (initialJSON !== lastContentRef.current) {
      ...
      editor.commands.setContent((initialJSON as never) ?? "", { emitUpdate: false });
    }
  }, [initialJSON, editor]);
