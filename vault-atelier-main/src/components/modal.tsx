      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className={`w-full ${maxWidth} bg-card border border-border rounded-2xl shadow-2xl overflow-hidden`}
...
export function Confirm({
  open, onClose, onConfirm, title, description, confirmText = "Confirm", destructive,
}: {
