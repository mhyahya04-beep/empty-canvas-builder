...
const FAMILIES: { key: ThemeFamily; name: string; description: string; swatch: string[] }[] = [
  { key: "vaultAtelier", name: "Vault Atelier", description: "Deep charcoal & muted gold — the premium signature.", swatch: ["#141414", "#1a1a1a", "#d9c084"] },
  { key: "midnightArchive", name: "Midnight Archive", description: "Modern dark, focused and clean.", swatch: ["#1f1d1a", "#2b2926", "#d9c084"] },
  { key: "ivoryWorkspace", name: "Ivory Workspace", description: "Soft cream, professional academic.", swatch: ["#f6f1e6", "#e9dec8", "#8a6a3a"] },
  { key: "velvetStudio", name: "Velvet Studio", description: "Deep crimson, cream, refined studio.", swatch: ["#f8e6e8", "#f1cdd2", "#c4708a"] },
...
export function SettingsModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Settings" maxWidth="max-w-2xl"
      footer={<p className="text-[10px] text-muted-foreground w-full text-center">Vault Atelier — Merged Archive Edition</p>}
    >
